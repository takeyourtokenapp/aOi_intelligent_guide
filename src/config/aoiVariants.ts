...
export const AOI_VARIANTS: Record<AoiVariant, AoiVariantConfig> = {
  ...
  pointing: {
    variant: 'pointing',
    path: '/assets/aoi/aoi-pointing.png',
  ...
  presenting: {
    variant: 'presenting',
    path: '/assets/aoi/aoi-presenting.png',
  ...
  portrait: {
    variant: 'portrait',
    path: '/assets/aoi/aoi-portrait.png',
  ...
  celebration: {
    variant: 'celebration',
    path: '/assets/aoi/aoi-celebration.png',
    fallbackPath: '/aoi/builder-excited.png',
    alt: 'aOi celebrating',
    objectPosition: 'center',
    scale: '1',
