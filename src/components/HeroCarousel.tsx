...
export function HeroCarousel({ onAoiClick, onNavigate }: HeroCarouselProps) {
    ...
    <div className="relative h-full bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 dark:from-[#2a3f54] dark:via-[#1B2838] dark:to-[#2a3f54] rounded-2xl md:rounded-3xl p-4 sm:p-6 md:p-8 lg:p-10 border-2 border-purple-300 dark:border-[#9B8FD9]/40 flex items-center">
      <div className="w-full">
        <div className="flex items-center gap-2 sm:gap-3 mb-3 sm:mb-4 md:mb-6">
          ...
          <span className="text-[#9B8FD9] font-bold uppercase tracking-wider text-xs sm:text-sm">
            {language === 'en' ? 'NEW RESEARCH PAPER' : 'НОВАЯ РАБОТА'}
          </span>
        </div>

        <div className="grid md:grid-cols-[auto_1fr] gap-4 sm:gap-6 md:gap-8 items-start">
          <div className="w-14 h-14 sm:w-16 sm:h-16 md:w-20 md:h-20 bg-[#9B8FD9] rounded-xl sm:rounded-2xl flex items-center justify-center flex-shrink-0 mx-auto md:mx-0">
          ...
          <div>
            ...
            <p className="text-[#9B8FD9] font-medium mb-2 sm:mb-3 md:mb-4 text-xs sm:text-sm md:text-base">
            ...
            <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-3 sm:mb-4 md:mb-6">
              ...
              <span className="px-2 sm:px-2.5 md:px-3 py-0.5 sm:py-1 bg-[#8FA68E]/20 text-[#8FA68E] rounded-lg text-xs sm:text-sm border border-[#8FA68E]/30">Blockchain</span>
              ...
              <span className="px-2 sm:px-2.5 md:px-3 py-0.5 sm:py-1 bg-[#D97B8F]/20 text-[#D97B8F] rounded-lg text-xs sm:text-sm border border-[#D97B8F]/30">Oncology</span>
              <span className="px-2 sm:px-2.5 md:px-3 py-0.5 sm:py-1 bg-[#9B8FD9]/20 text-[#9B8FD9] rounded-lg text-xs sm:text-sm border border-[#9B8FD9]/30">I-QCC</span>
            </div>

            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4">
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-8 h-8 sm:w-9 sm:h-9 md:w-10 md:h-10 bg-[#9B8FD9] rounded-full flex items-center justify-center text-white font-bold text-xs sm:text-sm md:text-base">
                  葵
                </div>
                <div>
              ...
              <button
                ...
                className="w-full sm:w-auto sm:ml-auto px-4 sm:px-5 md:px-6 py-2 sm:py-2.5 bg-[#9B8FD9] hover:bg-[#8B7AC7] text-white rounded-lg sm:rounded-xl font-bold transition-colors flex items-center justify-center gap-2 text-xs sm:text-sm md:text-base shadow-lg"
              >
  ...
  return (
    <div className="relative mb-8 sm:mb-12 md:mb-16 overflow-hidden">
      <div className="relative min-h-[450px] h-auto sm:h-[520px] md:h-[550px] lg:h-[600px] transition-all duration-700">
        {renderSlide()}
