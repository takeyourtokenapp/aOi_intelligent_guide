...
export function HeroCarousel({ onAoiClick, onNavigate }: HeroCarouselProps) {
    ...
    <div className="relative bg-gradient-to-br from-[#1B2838] via-[#2a3f54] to-[#1B2838] rounded-3xl p-12 min-h-[600px] flex items-center justify-center border-2 border-[#9B8FD9]/30">
      <div className="grid md:grid-cols-2 gap-12 items-center max-w-6xl w-full">
        ...
        <div className="text-white">
          ...
          <div className="bg-[#2a3f54] rounded-2xl p-6 mb-6 border border-[#9B8FD9]/20">
  ...
  const renderResearchSlide = () => (
    <div className="relative bg-gradient-to-br from-[#2a3f54] via-[#1B2838] to-[#2a3f54] rounded-3xl p-10 border-2 border-[#9B8FD9]/40">
      <div className="flex items-center gap-3 mb-6">
        <Sparkles className="w-6 h-6 text-[#9B8FD9]" />
        <span className="text-[#9B8FD9] font-bold uppercase tracking-wider text-sm">
          {language === 'en' ? 'NEW RESEARCH PAPER' : 'НОВАЯ ИССЛЕДОВАТЕЛЬСКАЯ РАБОТА'}
        </span>
      </div>

      <div className="grid md:grid-cols-[auto_1fr] gap-8 items-start">
        <div className="w-20 h-20 bg-[#9B8FD9] rounded-2xl flex items-center justify-center">
        ...
        <div>
          ...
          <p className="text-[#9B8FD9] font-medium mb-4">
          ...
          <div className="flex flex-wrap gap-2 mb-6">
            <span className="px-3 py-1 bg-[#9B8FD9]/20 text-[#9B8FD9] rounded-lg text-sm border border-[#9B8FD9]/30">AI</span>
            <span className="px-3 py-1 bg-[#7BA7BC]/20 text-[#7BA7BC] rounded-lg text-sm border border-[#7BA7BC]/30">Quantum Computing</span>
            <span className="px-3 py-1 bg-[#8FA68E]/20 text-[#8FA68E] rounded-lg text-sm border border-[#8FA68E]/30">Blockchain</span>
            <span className="px-3 py-1 bg-[#E8B4B8]/20 text-[#E8B4B8] rounded-lg text-sm border border-[#E8B4B8]/30">DeSci</span>
            <span className="px-3 py-1 bg-[#D97B8F]/20 text-[#D97B8F] rounded-lg text-sm border border-[#D97B8F]/30">Pediatric Oncology</span>
            <span className="px-3 py-1 bg-[#9B8FD9]/20 text-[#9B8FD9] rounded-lg text-sm border border-[#9B8FD9]/30">I-QCC</span>
          </div>

          <div className="flex items-center gap-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 bg-[#9B8FD9] rounded-full flex items-center justify-center text-white font-bold">
                葵
              </div>
              <div>
                <p className="text-white font-bold text-sm">aOi - AI Curator</p>
  ...
  const renderEcosystemSlide = () => (
    <div className="relative bg-gradient-to-br from-[#1B2838] via-[#2a3f54] to-[#1B2838] rounded-3xl p-10 border-2 border-[#7BA7BC]/30">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <div className="bg-[#2a3f54] border-2 border-[#D97B8F]/30 rounded-2xl p-6 hover:border-[#D97B8F]/60 transition-all">
          <div className="w-16 h-16 bg-[#D97B8F]/20 rounded-2xl flex items-center justify-center mb-4 mx-auto">
            <FileText className="w-8 h-8 text-[#E8B4B8]" />
          </div>
          <h3 className="text-[#E8B4B8] font-bold text-xl mb-3 text-center">
        ...
        <div className="bg-[#2a3f54] border-2 border-[#7BA7BC]/30 rounded-2xl p-6 hover:border-[#7BA7BC]/60 transition-all">
          <div className="w-16 h-16 bg-[#7BA7BC]/20 rounded-2xl flex items-center justify-center mb-4 mx-auto">
            <Network className="w-8 h-8 text-[#7BA7BC]" />
          </div>
          <h3 className="text-[#7BA7BC] font-bold text-xl mb-3 text-center">
        ...
        <div className="bg-[#2a3f54] border-2 border-[#9B8FD9]/30 rounded-2xl p-6 hover:border-[#9B8FD9]/60 transition-all">
          <div className="w-16 h-16 bg-[#9B8FD9]/20 rounded-2xl flex items-center justify-center mb-4 mx-auto text-4xl">
            葵
          </div>
          <h3 className="text-[#9B8FD9] font-bold text-xl mb-3 text-center">
